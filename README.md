...
- 🌱 &nbsp;Product Manager with a background in software engineering + UX design.
- ⚙️ &nbsp;I like working close to the problem, shipping fast, and making sure what we build actually holds up.
- 🤖 &nbsp;Exploring how AI can improve product work, and exploring new horizons along the way.
...
I care about execution. Taking ideas from zero to shipped, working closely with engineers and stakeholders, and using AI where it actually helps speed and quality.

_Ps: I still get my hands dirty with code when needed._
